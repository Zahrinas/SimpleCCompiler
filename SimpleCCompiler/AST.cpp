...
std::string AST_node::toLLVM_type() {
	if (type == dataType::int_type) return std::string("i64");
	...
	else if (type == dataType::int_pointer) return std::string("i64*");
		...
		if (value.type == dataType::int_type) return "i64";
